...
<html lang="en">
<head>
	<title>Septillion / Espace Client</title>
	<meta charset="UTF-8">
			...
			<div class="row">
				...
				<div class="col-md-6 p-b-30">
					<form class="leave-comment" action="login_script.php" method="post">
						...
						<div class="bo4 of-hidden size15 m-b-20">
							<input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="password" placeholder="Votre mot de passe">
						</div>
				...
				<div class="col-md-6 p-b-30">
					<form class="leave-comment" action="login_script.php" method="post">
						...
						<div class="bo4 of-hidden size15 m-b-20">
							<input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="password" placeholder="Mot de passe">
						</div>

						<div class="bo4 of-hidden size15 m-b-20">
							<input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="password_conf" placeholder="Confirmer votre mot de passe">
						</div>
						<!--textarea class="dis-block s-text7 size20 bo4 p-l-22 p-r-22 p-t-13 m-b-20" name="message" placeholder="Message"></textarea-->
