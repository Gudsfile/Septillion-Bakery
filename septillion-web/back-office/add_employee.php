...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
  ...
  <div class="row">
    <div class="panel-body">
      <form class="form-horizontal row-border" enctype="multipart/form-data" action="script_add_employee.php" method="post">
        ...
        <div class="form-group">
          ...
          <div class="col-md-10">
            <input type="text" name="verif_mail" class="form-control">
          </div>
        </div>
        <div class="form-group">
