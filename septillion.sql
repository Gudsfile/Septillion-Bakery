...
ALTER TABLE IMAGE AUTO_INCREMENT=1001;
...
ALTER TABLE CATEGORY
  ADD CONSTRAINT fk_category_created_by FOREIGN KEY (CREATED_BY) REFERENCES EMPLOYEE (ID_EMPLOYEE);
  ADD CONSTRAINT fk_category_image FOREIGN KEY (ID_IMG) REFERENCES IMAGE (ID_IMG);
...
ALTER TABLE PRODUCT
  ...
  ADD CONSTRAINT fk_product_image FOREIGN KEY (ID_IMG) REFERENCES IMAGE (ID_IMG) ON DELETE CASCADE;
